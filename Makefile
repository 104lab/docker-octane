...
8.3:
	docker build --progress=plain -t=octane:8.3 8.3
	docker build --progress=plain -t=octane:8.3-alpine 8.3/alpine

8.2:
	docker build --progress=plain -t=octane:8.2 8.2
	docker build --progress=plain -t=octane:8.2-alpine 8.2/alpine
